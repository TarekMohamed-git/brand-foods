                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="unit" class="form-control js-select2-custom">
                                        <option value="كرتونه 12 قطعه">{{translate('unit1')}}</option>
                                        <option value="علبة 12 قطعه">{{translate('unit2')}}</option>
                                        <option value="علبة 24 قطعه">{{translate('unit3')}}</option>
                                        <option value="شرينك 10 قطعه">{{translate('unit4')}}</option>
                                        <option value="شرينك 12 قطعه">{{translate('unit5')}}</option>
                                        <option value="علبة 16 قطعة">{{translate('unit6')}}</option>
                                        <option value="علبة 15 كيس">{{translate('unit7')}}</option>
                                        <option value="شرنك 24 قطعة">{{translate('unit8')}}</option>
