                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="unit" class="form-control js-select2-custom">
                                        <option value="كرتونه 12 قطعه" {{$product['unit']=='كرتونه 12 قطعه'?'selected':''}}>{{translate('unit1')}}</option>
                                        <option value="علبة 12 قطعه" {{$product['unit']=='علبة 12 قطعه'?'selected':''}}>{{translate('unit2')}}</option>
                                        <option value="علبة 24 قطعه" {{$product['unit']=='علبة 24 قطعه'?'selected':''}}>{{translate('unit3')}}</option>
                                        <option value="شرينك 10 قطعه" {{$product['unit']=='شرينك 10 قطعه'?'selected':''}}>{{translate('unit4')}}</option>
                                        <option value="شرينك 12 قطعه" {{$product['unit']=='شرينك 12 قطعه'?'selected':''}}>{{translate('unit5')}}</option>
                                        <option value="علبة 16 قطعة" {{$product['unit']=='علبة 16 قطعة'?'selected':''}}>{{translate('unit6')}}</option>
                                        <option value="علبة 15 كيس" {{$product['unit']=='علبة 15 كيس'?'selected':''}}>{{translate('unit7')}}</option>
                                        <option value="شرنك 24 قطعة" {{$product['unit']=='شرنك 24 قطعة'?'selected':''}}>{{translate('unit8')}}</option>
