            ...
            <!-- Quantity + Add to cart -->
                ...
                <div class="d-flex justify-content-center mt-2">
                    ...
                    <button class="btn btn-primary"
                            onclick="addToCartAndRefreshWithDelay()"
                            type="button"
...
<script>
    ...
    function addToCartAndRefreshWithDelay() {
      // Add your code to handle adding to cart here
      // For example, you might make an API call to add the item to the cart
      addToCart();

      // After adding to cart, wait for 1 second before reloading the page
      setTimeout(function() {
        location.reload();
      }, 100);
