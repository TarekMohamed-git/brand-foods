                        ...
                        @foreach($orders as $key=>$order)
                            ...
                            <tr class="status-{{$order['order_status']}} class-all">
                                ...
                                <td>
                                    ...
                                    onclick="form_alert('order-{{$order['id']}}','{{translate('Want to delete this order ?')}}')">
                                    ...
                                    <form action="{{route('admin.order.delete',[$order['id']])}}"
                                        ...
                                        <a class="action-btn btn--primary btn-outline-primary" href="{{route('admin.orders.details',['id'=>$order['id']])}}">
                                        ...
                                        <a class="action-btn btn-outline-primary-2" target="_blank" href="{{route('admin.orders.generate-invoicea4',[$order['id']])}}">
                                            <i class="tio-print">A4</i>
                                        </a>
