<!DOCTYPE html>
{{--<html lang="{{ str_replace('_', '-', app()->getLocale() == "ar"? 'rtl' :'') }}" >--}}
...
{{--    <title>@yield('title')</title>--}}
  @if(app()->getLocale() =='ar')
    <title>{{config('app.name')}}{{' - التاجر | '}} @yield('title')</title>
  @else
    <title>{{config('app.name')}}{{' - vendor | '}} @yield('title')</title>
  @endif
    <!-- Favicon -->
...
<body class="navbar-vertical-aside-mini-mode">
...
//     // Remove existing classes from the body element (if any)
//     body.classList.remove(...body.classList);

//     // Add the classes to the body element
//     body.classList.add("footer-offset", "has-navbar-vertical-aside", "navbar-vertical-aside-show-xl", "navbar-vertical-aside-mini-mode");
//   });
</script>
